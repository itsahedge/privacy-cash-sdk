...
import { TRANSACT_IX_DISCRIMINATOR, TRANSACT_SPL_IX_DISCRIMINATOR, SIGN_MESSAGE, } from "./constants.js";
...
export class EncryptionService {
    ...
    static ENCRYPTION_VERSION_V2 = Buffer.from([
     ...
     */
    async deriveEncryptionKeyFromPrivyWallet(privyWallet) {
